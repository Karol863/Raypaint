...
int main(void) {
    ...
    while (!WindowShouldClose()) {
        ...
        if (IsMouseButtonPressed(MOUSE_LEFT_BUTTON) && CheckCollisionPointRec(mousepos, save_rectangle)) {
        ...
        if (IsMouseButtonPressed(MOUSE_BUTTON_RIGHT) || GetGestureDetected() == GESTURE_DRAG) {
            if (mousepos.x > 80) {
